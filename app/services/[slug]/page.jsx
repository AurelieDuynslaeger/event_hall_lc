...
import ServicesDescription from '@/components/ServicesDescription/ServiceDescription'
...
const serviceData = {
    ...
    tablehote: {
        ...
        img:[
          {name: "Vue Piscine", handle: "view_1"},
          {name: "Vue Piscine", handle: "view_2"},
          {name: "Vue Piscine", handle: "view_3"},
          {name: "Vue Piscine", handle: "view_4"},
      ...
      <>
        {slug === "receptions" ? (
            ...
            {service.img.map(({ handle }, i) => (
              ...
              <ServicesDescription mousePosition={mousePosition} services={service.img} slug={slug}/>
              </section>
