    ...
    return (
        <Link href={roomDetailUrl}>
            <div 
                ...
                className="group flex w-full justify-between items-center py-8 px-24 border-t cursor-pointer transition duration-200 hover:opacity-50 last-of-type:border-b border-gray-300">
