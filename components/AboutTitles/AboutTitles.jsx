...
function Title({data, setSelectedProject}){
  ...
  return (
    <div ref={container} className="cursor-default relative z-10">
            ...
            >
                <motion.p style={{clipPath: clip}} className="inline-block text-white uppercase font-bold text-[4vw] leading-[5vw] m-0 relative z-10">
                    {title}
                </motion.p>
                {/* <p className="block absolute text-[#1c1c1c] top-0 z-0">
                    {title}
                </p> */}
            </div>
        </div>
