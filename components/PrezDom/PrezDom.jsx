...
const PrezDom = () => {
  return (
    <section
      className="mx-auto max-w-8xl pt-80 pb-0 text-primary"
    >
      <motion.h1
        initial={{ y: 48, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ ease: "easeInOut", duration: 0.75 }}
        className="font-stretch mb-12 text-8xl font-bold text-center leading-1"
      >
        A spot. Your vision. <span className='text-9xl'>Results.</span>
      </motion.h1>
    ...
    <div className='flex max-w-7xl m-auto gap-8 items-end justify-end'>
      ...
      <motion.h2 
       ...
       whileInView={{ y: 0, opacity: 1 }}
       transition={{ ease: "easeInOut", duration: 0.75 }}
        className='text-4xl font-stretch my-8 max-w-5xl text-right text-pretty m-auto leading-loose'>
      ...
      <motion.p 
       ...
       whileInView={{ y: 0, opacity: 1 }}
       transition={{ ease: "easeInOut", duration: 0.75 }}
        className='text-4xl text-right font-stretch my-8 max-w-5xl text-pretty m-auto leading-loose'>
