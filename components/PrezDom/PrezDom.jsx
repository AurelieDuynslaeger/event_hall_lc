...
const PrezDom = () => {
  return (
    <section
      className="mx-auto max-w-5xl px-4 pt-72 pb-12 text-black"
    >
      <motion.h1
      ...
      <motion.p 
       ...
       transition={{ ease: "easeInOut", duration: 0.75 }}
        ...
        A la frontière du Gers et du Lot-et-Garonne, le Domaine s&apos;étend sur plus de 13 hectares.
      </motion.p>

      <motion.p 
       initial={{ y: 48, opacity: 0 }}
       whileInView={{ y: 0, opacity: 1 }}
       transition={{ ease: "easeInOut", duration: 0.75 }}className='text-2xl my-6'>
        Vos hôtes vous accueillent dans un Corps de garde du XV siècle et ses dépendances, alliant histoire, charme et authenticité.
      </motion.p>
